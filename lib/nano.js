...
module.exports = exports = nano = function dbScope(cfg) {
  ...
  function relax(opts, callback) {
    ...
    if (opts.db) {
      req.uri = urlResolveFix(req.uri, encodeURIComponent(opts.db)+opts.security);
    }
  ...
  function docModule(dbName) {
    ...
    function insertDocSec(doc, callback) {
        var opts = {db: dbName, body: doc, method: 'PUT', security: "/_security"};
        return relax(opts, callback);
    }
